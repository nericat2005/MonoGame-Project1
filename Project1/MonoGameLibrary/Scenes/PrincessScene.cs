...
public class PrincessScene : Scene
{
    // Defines the slime animated sprite.
    private AnimatedSprite _slime;
    private AnimatedSprite _princess;
    ...
    public override void LoadContent()
    {
        ...
        _princess = atlas.CreateAnimatedSprite("slime-animation");
        _princess.Scale = new Vector2(4.0f, 4.0f);
