...
public class GameScene : Scene
{
    ...
    //Implement door sprite, and 3 positions
    private Texture2D _frontDoor;
    private Texture2D _leftDoor;
    private Texture2D _rightDoor;
    private Vector2 _frontDoorPos;
    private Vector2 _leftDoorPos;
    ...
    public override void LoadContent()
    {
        ...
        //create a texture 2D door sprite
        _frontDoor = Core.Content.Load<Texture2D>("images/door");
        _leftDoor = Core.Content.Load<Texture2D>("images/door");
        _rightDoor = Core.Content.Load<Texture2D>("images/door");

        // Set its position
        _frontDoorPos = new Vector2(
            screenBounds.Width/2 - _frontDoor.Width / 2,
            0
        );
        _rightDoorPos = new Vector2(
            screenBounds.Width - _rightDoor.Width,
            screenBounds.Height / 2 - _rightDoor.Height / 2
        );
        _leftDoorPos = new Vector2(
            0,
            screenBounds.Height / 2 - _leftDoor.Height / 2
        );
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        Circle frontDoorBounds = new Circle(
            (int)(_frontDoorPos.X + (_frontDoor.Width * 0.5f)),
            (int)(_frontDoorPos.Y + (_frontDoor.Height * 0.5f)),
            (int)(_frontDoor.Width * 0.5f)
        );
        ...
        {
            //Change scene to PrincessScene. Save count for the amount of times this is triggered..?
            Core.ChangeScene(new PrincessScene());
            // Play the door opening sound effect.
            //Core.Audio.PlaySoundEffect(_collectSoundEffect);
            // Increase the player's score.
            //_score += 100;
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        Core.SpriteBatch.Draw(_frontDoor, _frontDoorPos, Color.White);
